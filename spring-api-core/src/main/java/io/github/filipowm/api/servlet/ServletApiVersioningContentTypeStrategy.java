...
@Slf4j
public class ServletApiVersioningContentTypeStrategy extends AbstractApiVersioningStrategy<RequestMappingInfo> implements InitializingBean {

    private final String contentTypeVnd;

    private final String versionPrefix;

    public ServletApiVersioningContentTypeStrategy(ApiVersionNamingProvider namingProvider, String contentTypeVnd, String versionPrefix) {
