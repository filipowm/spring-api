 ...
 */
@Slf4j
public class ReactiveApiRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
    ...
    public ReactiveApiRequestMappingHandlerMapping(List<ApiDecorator> apiDecorators,
    ...
    protected RequestMappingInfo getMappingForMethod(Method method, Class<?> handlerType) {
        ...
        if (api != null) {
            ...
            var builder = new ReactiveApiBuilder(api, method, handlerType, info, pathPrefix, versionPrefix, contentTypeVnd);
    ...
    private RequestMappingInfo getMappingForApi(ReactiveApiBuilder builder) {
