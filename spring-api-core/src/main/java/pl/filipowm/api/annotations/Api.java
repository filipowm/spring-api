package pl.filipowm.api.annotations;
 ...
 * Controllers marked with <b>@Api</b> will be registered by {@link pl.filipowm.api.ApiRequestMappingHandlerMapping}
 ...
 * be defined on method level. If <i>value</i> parameter is missing, then {@link pl.filipowm.api.EmptyPathNamingProvider}
 * is used to determine path. By default {@link pl.filipowm.api.BasePathNamingProvider} is used.
 * <p>
 * Example:
 * <pre>
 * &#64;Api(value = "examples",
 ...
 * </pre>
 * <p>
 * Depending on your other configuration of versioning ({@link pl.filipowm.api.ApiVersionStrategy}), path
 * prefix ({@link pl.filipowm.api.ApiPathEnhancer} and base context ({@link pl.filipowm.api.ContextPathEnhancer},
